...
MARKETS = {
    "crypto": {
        ...
        "assets": [
            ...
            {"symbol": "TONUSDT", "name": "Toncoin / USDT"},
            ...
            {"symbol": "OPUSDT", "name": "Optimism / USDT"},
            {"symbol": "ARBUSDT", "name": "Arbitrum / USDT"},
        ],
    },
    "br_stock": {
        ...
        "assets": [
            ...
            {"symbol": "RDOR3.SA", "name": "Rede D'Or ON"},
            {"symbol": "BBSE3.SA", "name": "BB Seguridade ON"},
            {"symbol": "EQTL3.SA", "name": "Equatorial ON"},
            {"symbol": "CSNA3.SA", "name": "CSN ON"},
            {"symbol": "HAPV3.SA", "name": "Hapvida ON"},
            {"symbol": "VIVT3.SA", "name": "Telefonica Brasil ON"},
            {"symbol": "TAEE11.SA", "name": "Taesa Unit"},
        ],
    },
    "us_stock": {
    ...
    "forex": {
        ...
        "assets": [
            ...
            {"symbol": "NZDUSD", "name": "Dolar neozelandes / Dolar"},
            {"symbol": "EURJPY", "name": "Euro / Iene"},
            {"symbol": "GBPJPY", "name": "Libra / Iene"},
            {"symbol": "AUDJPY", "name": "Dolar australiano / Iene"},
            {"symbol": "EURGBP", "name": "Euro / Libra"},
            {"symbol": "EURAUD", "name": "Euro / Dolar australiano"},
            {"symbol": "CHFJPY", "name": "Franco suico / Iene"},
            {"symbol": "CADJPY", "name": "Dolar canadense / Iene"},
        ],
    },
    "futures_b3": {
        "label": "Futuros B3",
        ...
        "assets": [
            ...
            {"symbol": "IND", "name": "Indice cheio atual", "tv_symbol": "BMFBOVESPA:IND1!", "aliases": ["IND1!", "IND1"]},
            {"symbol": "DOL", "name": "Dolar cheio atual", "tv_symbol": "BMFBOVESPA:DOL1!", "aliases": ["DOL1!", "DOL1"]},
        ],
    },
    "commodity": {
        "label": "Commodities",
        ...
        "assets": [
            ...
            {"symbol": "BRENT", "name": "Petroleo Brent"},
            {"symbol": "COPPER", "name": "Cobre"},
            {"symbol": "PLATINUM", "name": "Platina"},
            {"symbol": "COFFEE", "name": "Cafe"},
            {"symbol": "SUGAR", "name": "Acucar"},
            {"symbol": "CORN", "name": "Milho"},
            {"symbol": "SOYBEAN", "name": "Soja"},
        ],
    },
    "index": {
        "label": "Indices",
...
class MarketDataRouter:
    ...
    def normalize_symbol(self, symbol):
        ...
        if value in {"WDO1!", "WDO1"}:
            return "WDO"
        if value in {"IND1!", "IND1"}:
            return "IND"
        if value in {"DOL1!", "DOL1"}:
            return "DOL"
